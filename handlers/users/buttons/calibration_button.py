...
@dp.callback_query_handler(state=ClientStatesGroup.menu, text='calibration_button')
async def calibration(callback: types.CallbackQuery, state: FSMContext):
    ...
    text.append('Калибровка завершена!')
    text = '\n'.join(text)
